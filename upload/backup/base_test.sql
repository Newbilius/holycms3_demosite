...
CREATE TABLE `banners` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` text NOT NULL,  `caption` text NOT NULL,  `sort` int(11) NOT NULL,  `parent` int(11) NOT NULL,  `folder` int(11) NOT NULL,  `url` text NOT NULL,  `foto` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `catalog` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` text NOT NULL,  `caption` text NOT NULL,  `sort` int(11) NOT NULL,  `parent` int(11) NOT NULL,  `folder` int(11) NOT NULL,  `detail_text` longtext NOT NULL,  `cost` double NOT NULL,  `foto` text NOT NULL,  `foto_multi` text NOT NULL,  `spec1` smallint(6) NOT NULL,  `caption2` text NOT NULL,  `description` longtext NOT NULL,  `keywords` longtext NOT NULL,  `other` text NOT NULL,  `tags` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `foto` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` text NOT NULL,  `caption` text NOT NULL,  `sort` int(11) NOT NULL,  `parent` int(11) NOT NULL,  `folder` int(11) NOT NULL,  `foto` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=52 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `news` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` text NOT NULL,  `caption` text NOT NULL,  `sort` int(11) NOT NULL,  `parent` int(11) NOT NULL,  `folder` int(11) NOT NULL,  `preview_text` longtext NOT NULL,  `detail_text` longtext NOT NULL,  `caption2` text NOT NULL,  `description` longtext NOT NULL,  `keywords` longtext NOT NULL,  `sdate` date NOT NULL,  `foto` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=55 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `site_users` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` text NOT NULL,  `caption` text NOT NULL,  `sort` int(11) NOT NULL,  `parent` int(11) NOT NULL,  `folder` int(11) NOT NULL,  `fio` text NOT NULL,  `email` text NOT NULL,  `address` longtext NOT NULL,  `uid` text NOT NULL,  `password` text NOT NULL,  `uic_rec` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=cp1251;
...
INSERT INTO users VALUES("1","administrator_sayta","Администратор сайта","200","0","0","admin","demo@mail.ru","1","21232f297a57a5a743894a0e4a801fc3","8c196e692dced06bec31a84d12a0a7d1");
